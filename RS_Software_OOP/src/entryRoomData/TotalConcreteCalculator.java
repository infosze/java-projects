...
//					System.out.println("5");
			...
			totalPrice += price;
			System.out.printf("neve: %s, a szükséges mennyiség: %.0f csomag, ennek ára: %.0f forint%n", selectedMaterials[i],
					selectedMatTotalPackRounded, price);
			offer += String.format("neve: %s, a szükséges mennyiség: %.0f csomag, ennek ára: %.0f forint%n", selectedMaterials[i],
					selectedMatTotalPackRounded, price);
		}
