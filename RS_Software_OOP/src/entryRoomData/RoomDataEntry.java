...
public class RoomDataEntry {
	...
	public void addRoomData() {
		...
		double roomHeight;
		int roomNumber = 0;
		String questionFloor = "AKAR PADLÓKIEGYENLÍTÉST?";
		String questionCarpet = "AKAR PADLÓSZŐNYEGET?";
		String questionParquet = "AKAR SZALAGPARKETTÁT?";
		String questionWallPaper = "AKAR TAPÉTÁT?";
		String roomWidthText = "Szélesség (méterben):";
		String roomLengthText = "Hosszúság (méterben):";
		String roomHightText = "Magasság (méterben) :";
		String questionDiscount = "AKAR KEDVEZMÉNYT ADNI?";

//		do {
//			String[] customer = customers.getCustomer();
...
//		}
	...
	public String goodOrNoDataEntry() {
		...
		do {
			notGoodData = false;
			System.out.printf("ADATBEVITEL JÓ? (\"i\"-igen / \"u\"-újra) ");
